...
// call this when modal shows up for likes
function getLikers(arrayOfLikes) {
	let likesArrayOfUserObjects = [];
	if (arrayOfLikes.length !== 0) {
		arrayOfLikes.forEach(userId => {
			$.get(`/users/${userId}`, user => {
				likesArrayOfUserObjects.push(user);
				console.log(likesArrayOfUserObjects[0].name);
			});
		});
	}
	return likesArrayOfUserObjects;
}
        ...
        <div class="crayons-story post" data-id=${post._id}>
                ...
                <div class="crayons-story__body">
                    ...
                    <div class="crayons-story__indention">
						...
						<button style="border:none;background:white;" class="text-muted small" data-toggle="modal" data-target="#likesModal" data-likes="[${
							post.likes
